Feature: The player causes a volcanic eruption by adding a tile to Tiger island.
  The eruption either adds  new hexes to the island or increases the level of three existing hexes.
